          ...
          <AnimatePresence>
            {tooltip && (
              <motion.div
                ...
                className="relative flex items-center gap-2 bg-white rounded-2xl
                           shadow-card-hover px-4 py-3 border border-slate-100 max-w-[220px]"
              >
                <button
                  onClick={() => setTooltip(false)}
                  className="absolute -top-2 -right-2 w-5 h-5 rounded-full bg-slate-200
                             flex items-center justify-center hover:bg-slate-300 transition-colors"
                  aria-label="Dismiss"
                >
